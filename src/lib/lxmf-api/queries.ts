import {
  ...
  type LxmfPropagationEnableInput,
  type LxmfPropagationFetchInput,
  type LxmfPropagationFetchResponse,
  type LxmfPropagationIngestInput,
  ...
  type LxmfSetInterfacesInput,
  type LxmfSetInterfacesResponse,
  type LxmfStampPolicyResponse,
  type LxmfStampPolicyUpdate,
  type LxmfTicketGenerateInput,
